//
//  ConsumerDetailServicesOfferedTableViewCell.swift
//  HoneySpot
//
...
class ConsumerDetailServicesOfferedTableViewCell: UITableViewCell {
    ...
    func prepareCell(spotSavemodel:SpotSaveModel){
        ...
        self.serviceOfferedCollectionView.collectionViewLayout = createLeftAlignedLayoutTag()
        if self.spotModel.deliveryOptions == nil
        {
            noDataLabel.isHidden = false
            self.serviceOfferedCollectionView.isHidden = true
        }
        else
        {
            ...
            else
            {
                ...
                self.serviceOfferedCollectionView.isHidden = false
...
extension ConsumerDetailServicesOfferedTableViewCell : UICollectionViewDelegate , UICollectionViewDataSource{
...
extension ConsumerDetailServicesOfferedTableViewCell {
